'''
 ...
 Date        : 04.09.2018
 Version     : 1.0
 Description : LogisticRegression Machine Learning Algorithm
'''
...
model = LogisticRegression() # this is model instance
...
'''
output accuracy of the model using Kfold (k=10) CV is 76.95 %. We can also try other CV techniques to find accuracies.
...
Hence the variable 'model' contains the LogisticRegression model. 
'''
