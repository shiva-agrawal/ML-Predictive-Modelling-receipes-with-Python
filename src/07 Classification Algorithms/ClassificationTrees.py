...
model = DecisionTreeClassifier() # this is model instance
...
'''
output accuracy of the model using Kfold (k=10) CV is 69.78 %. We can also try other CV techniques to find accuracies.
...
Hence the variable 'model' contains the Decision Tree Classifier model. 
'''
