'''
 ...
 Date        : 05.09.2018
 Version     : 1.0
 Description : K Nearest Neighbour - Regression Machine Learning Algorithm
'''
...
We can construct a KNN model for regression using the KNeighborsRegressor class
'''
...
model = KNeighborsRegressor() # this is model instance
...
'''
output: R2 value: 0.2277
output: MSE value: -31.16
'''
