'''
 ...
 Date        : 05.09.2018
 Version     : 1.0
 Description : LASSO linear Regression Machine Learning Algorithm
'''
...
the L1-norm). We can construct a LASSO model by using the Lasso class
'''
...
model = Lasso() # this is model instance
...
'''
output: R2 value: 0.1982
output: MSE value: -34.46
'''
