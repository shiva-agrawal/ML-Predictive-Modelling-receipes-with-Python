'''
 ...
 Date        : 05.09.2018
 Version     : 1.0
 Description : Elastic Net Regression Machine Learning Algorithm
'''
...
We can construct an ElasticNet model using the ElasticNet class
'''
...
model = ElasticNet() # this is model instance
