'''
 ...
 Date        : 01.09.2018
 Version     : 1.0
 Description : Import dataset in CSV format into Python for machine learning model development using numpy library
...
# Import Dataset in CSV format using 
...
ML_data = loadtxt(raw_data,delimiter = ",")
